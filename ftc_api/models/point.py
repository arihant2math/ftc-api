...
if TYPE_CHECKING:
    ...
    from ..models.coordinate_sequence import CoordinateSequence
...
class Point:
    ...
    Attributes:
        ...
        coordinate_sequence (Union[Unset, CoordinateSequence]):
    ...
    coordinate_sequence: Union[Unset, "CoordinateSequence"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        coordinate_sequence: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.coordinate_sequence, Unset):
            coordinate_sequence = self.coordinate_sequence.to_dict()
        ...
        if coordinate_sequence is not UNSET:
            field_dict["coordinateSequence"] = coordinate_sequence
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _coordinate_sequence = d.pop("coordinateSequence", UNSET)
        coordinate_sequence: Union[Unset, CoordinateSequence]
        if isinstance(_coordinate_sequence, Unset):
            coordinate_sequence = UNSET
        else:
            coordinate_sequence = CoordinateSequence.from_dict(_coordinate_sequence)
